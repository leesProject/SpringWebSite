...
<div>
	...
	<div id='content' style='width: 60%; border-color: black; border-style: solid; border-width: 1px; float: left; min-height: 80vh;overflow: auto;'>		
		...
		<form name="form1" action='/action/QA_post_modifyPost/${modify.postNum}' method = 'post'>
			
			
			<div style='width: 90%; margin-top: 5vh; margin-left: 5%;'>
				<!-- 제목 div 시작 -->
				<div style='height:5vh; width: 90.2%;'>
					<input name = 'postTitle' id = 'postTitle' type='text' style='width: 99.5%; height: 4vh;' placeholder="제목을 입력하세요" value="${modify.postTitle}" >		
				</div>
				<!-- 제목 div end-->				
			</div>
			...
			<div style='width: 81.5%; margin-top: 1vh; margin-left: 5%;'>		
				<textarea id="postContent" name='postContent' placeholder='게시물 설명'  style="resize: none; width: 99%; height: 60vh;">${modify.postContent} </textarea>
