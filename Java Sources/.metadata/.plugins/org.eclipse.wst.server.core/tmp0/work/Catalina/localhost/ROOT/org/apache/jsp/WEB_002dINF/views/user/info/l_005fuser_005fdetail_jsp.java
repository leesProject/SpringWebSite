 ...
 * Generated at: 2017-10-10 08:07:58 UTC
...
public final class l_005fuser_005fdetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div style=\"display: table-cell;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type='text' style=\"width: 99.8%; height: 2vh;\" readonly=\"readonly\" value=\"");
      ...
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div style=\"display: table-cell;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"email\" style=\"width: 99.8%; height: 2vh;\" readonly=\"readonly\"  value=\"");
      ...
      out.write("\t\t\t\t<button type=\"submit\" id='modifyBtn'  formaction=\"/action/User_modifyForm\" style='margin-top:2vh;height:3vh;'>修正する</button>\r\n");
      out.write("\t\t\t\t<button id='withdrawBtn' style='margin-top:2vh;height:3vh;'>脱退する</button>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<!-- <button id='buyHistoryBtn' style='margin-top:2vh;height:3vh;'>구매이력</button>\r\n");
      out.write("\t\t\t\t<button id='sellHistoryBtn' style='margin-top:2vh;height:3vh;'>판매이력</button>\t -->\t\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t\t</div>\t\t\t\r\n");
      out.write("\t\t\t<script>\r\n");
      out.write("\t\t\t\t$('#withdrawBtn').click(function(){\r\n");
      out.write("\t\t\t\t\tif(confirm('脱退しますか。')){\r\n");
      out.write("\t\t\t\t\t\twindow.open('/jsp/user/info/withdrawPopUp.jsp','popup',\"toolbar=no, location=no, resizable=no, scrollbars=no, width=600, height=250, left=0, top=0\")\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t})\r\n");
      out.write("\t\t\t</script>\r\n");
      out.write("\t\t\t</div>\t\r\n");
