 ...
 * Generated at: 2017-10-10 08:26:16 UTC
...
if(request.getAttribute("msg")!=null&&((MsgVO)request.getAttribute("msg")).getPageNum()!=0){
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t<button id='replyBtn' type='button'>送り直す</button>\r\n");
      ...
      out.write("\t\t\t\tif(confirm(\"このメールを削除しますか。\")){\r\n");
      ...
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class='msgReceiver'>\r\n");
      out.write("\t\t\t\t\t受信人:  ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${msg.receiverId}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("<br>\r\n");
      out.write("\t\t\t\t\t送信日:  ");
