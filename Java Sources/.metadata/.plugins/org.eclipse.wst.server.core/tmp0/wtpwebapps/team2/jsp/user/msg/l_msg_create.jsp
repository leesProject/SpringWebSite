...
<div>
	...
	<div id='content'>
		...
		<div>
			...
			受信人:<input type='text' id= 'receiverId' name='receiverId' value='${param.receiverId }' maxlength="20">	<br>
			タイトル:<input type='text' id='msgTitle' name='msgTitle' maxlength="30"><br>
			内容:<br>
			
			<textarea name='msgContent' id='msgContent' maxlength="1000" placeholder='入力内容は１０００文字までできます。' style='width: 98%;height: 60vh; resize: none;' onkeyup="countLetters(this)" onload="countLetters(this)"></textarea>
